...
from clients.http.courses.client import CoursesClient
from clients.http.courses.schema import CreateCourseRequestSchema, CreateCourseResponseSchema, GetCoursesQuerySchema, \
